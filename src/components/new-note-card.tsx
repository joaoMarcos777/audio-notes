                    ...
                    <form onSubmit={handleSaveNote} className='flex-1 flex flex-col'>
                        ...
                        <div className='flex flex-1 flex-col gap-3 p-5'>
                            ...
                            {shouldShowOnboarding ? (
                                <p className='text-sm leading-6 text-slate-400'>
                                    Start by <button className='font-medium text-lime-400 hover:underline'>recording an audio note</button> or if you prefer to <button onClick={handleStartEditor} className='font-medium text-lime-400 hover:underline'>use text only</button>.
                                </p>
                            ) : (
                                <textarea
                                    autoFocus
