                ...
                <Dialog.Content className='fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none'>
                    ...
                    <form className='flex-1 flex flex-col'>
                        ...
                        <div className='flex flex-1 flex-col gap-3 p-5'>
                            ...
                            {(shouldShowOnboarding && !isRecording && content == '') ? (
                                <p className='text-sm leading-6 text-slate-400'>
                                    Start by <button type='button' onClick={handleStartRecording} className='font-medium text-lime-400 hover:underline'>recording an audio note</button> or if you prefer to <button type='button' onClick={handleStartEditor} className='font-medium text-lime-400 hover:underline'>use text only</button>.
                                </p>
                            ) : (
                                <textarea
                                    autoFocus
